...
describe('CredentialsService', () => {
    ...
    describe('setCredentials', () => {
        it('should authenticate user if credentials are set', () => {
            // Act
            credentialsService.setCredentials({ email: 'testCred@mail.com', username: 'me', token: '123' });
        ...
        it('should persist credentials across sessions', () => {
            // Act
            credentialsService.setCredentials({ email: 'testCred@mail.com', username: 'me', token: '123' }, true);
